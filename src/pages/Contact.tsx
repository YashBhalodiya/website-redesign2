      ...
      <section className="pb-28 relative z-10">
        <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <ScrollReveal direction="right" className="lg:col-span-5 flex">
            <div className="w-full flex flex-col gap-8 text-left spotlight-card p-8 rounded-[24px]" onMouseMove={handleMouseMove}>
              <div>
          ...
          {/* Form - Right */}
          <ScrollReveal direction="left" className="lg:col-span-7 flex">
            <div className="w-full spotlight-card p-8 md:p-12 text-left rounded-[24px] relative overflow-hidden" onMouseMove={handleMouseMove}>
