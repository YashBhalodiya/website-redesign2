    ...
    <div className="overflow-x-hidden relative">
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-left">
            {positions.map((pos) => {
              const Icon = pos.icon;
              return (
                <div key={pos.id} className="glass-panel p-8 rounded-[24px] flex flex-col justify-between hover:border-accent-light/35 transition-colors relative group overflow-hidden">
                  ...
                  <button
                    ...
                    className="text-xs font-bold uppercase tracking-widest text-accent-light hover:text-primary self-start flex items-center gap-1 transition-colors relative z-10"
                  >
      ...
      <section className="py-28 relative z-10" id="apply-form-container">
        <div className="max-w-3xl mx-auto px-6">
          <div className="glass-panel p-8 md:p-12 text-left rounded-[32px] relative overflow-hidden">
